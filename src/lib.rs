...
macro_rules! impl_max {
  ($(#[$attr:meta]),* $max_ty:ident) => {
    ...
    /// #   SpiTransaction::transaction_start(),
    /// #   SpiTransaction::write_vec(vec![0b0001_0100, 0b11010010]), // Load input register A with value 1234.
    /// #   SpiTransaction::transaction_end(),
    /// #   SpiTransaction::transaction_start(),
    /// #   SpiTransaction::write_vec(vec![0b0010_1111, 0b11111111]), // Load input register B with value 4095.
    /// #   SpiTransaction::transaction_end(),
    /// #   SpiTransaction::transaction_start(),
    /// #   SpiTransaction::write_vec(vec![0b1000_0000, 0b00000000]), // Load DAC registers from input registers.
    /// #   SpiTransaction::transaction_end(),
    /// #   SpiTransaction::transaction_start(),
    /// #   SpiTransaction::write_vec(vec![0b1001_0100, 0b11010010]), // Load input register A with value 1234 and load DAC register A.
    /// #   SpiTransaction::transaction_end(),
    /// #   SpiTransaction::transaction_start(),
    /// #   SpiTransaction::write_vec(vec![0b1010_1111, 0b11111111]), // Load input register B with value 4095 and load DAC register B.
    /// #   SpiTransaction::transaction_end(),
    /// #   SpiTransaction::transaction_start(),
